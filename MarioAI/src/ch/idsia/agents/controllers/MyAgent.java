...
public class MyAgent extends BasicMarioAIAgent implements Agent
{
  ...
  {
    return hasEnemy(9,12) || !isEmpty(9,10) || !isEmpty(9,11) || !isEmpty(9, 12) || !isEmpty(9,13);
  }
  ...
  {
    return (isEmpty(10, 10) || isEmpty(10, 11) || isEmpty(10, 12)) && (!isEmpty(18,18) || !isEmpty(18,17));
  }
  ...
  public boolean aboveDanger()
  {
	...
	{
		action[Mario.KEY_JUMP] = !aboveDanger() && dropoff() || frontBlocked() && (isMarioAbleToJump || !isMarioOnGround);
    action[Mario.KEY_SPEED] = aboveDanger() || !frontEnemy() ;
		action[Mario.KEY_RIGHT] = true;
    action[Mario.KEY_LEFT] = frontEnemy();
        printObservation();
		return action;
	}
